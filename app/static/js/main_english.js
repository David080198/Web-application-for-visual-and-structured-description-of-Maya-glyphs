...
function orden_datos(orden,dato)
{
    ...
    enlace_pc_1 = enlace_actual_3 + "//" + enlace_actual_1 + ":" + result + "/index_ingles/" + orden + "/" + dato + "/default/default/default/#1"
...
function orden_datos_1(orden,dato)
{
    ...
    enlace_pc_1 = enlace_actual_3 + "//" + enlace_actual_1 + ":" + result + "/index_ingles_invitado/" + orden + "/" + dato + "/default/default/default/#1"
    console.log(enlace_pc_1)
